...
print("Exp kernel should run on DSP (core 4) with reduced memory and compute cycles.")
print("GEMM kernel should be unchanged (routes to Q32 cores, no compute scale applied).")
